...
import application.lib.views.custom.effects.Animated;
import application.lib.views.custom.effects.transitions.LabelSlider;
...
public class SlidingLabel extends javafx.scene.control.Label implements Animated
{
     ...
     */
    public void setInitialPadding (Insets insets)
    {
        setPadding(insets);
