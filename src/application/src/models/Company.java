...
import lib.csv.interfaces.CSVSaver;
...
public class Company implements Jsonable, JsonLoader, Serializable, CSVSaver
{
    ...
    private Company ()
    {
        try
        {
            serializationFilePath = Helper.serializationFilePath();
        }
        catch (IOException e)
        {
     ...
     * @return this
     */
    public Company setName (@NotNull String name)
    {
     ...
     */
    public static Employee createEmployee (@NotNull String firstName, @NotNull String lastName)
    {
     ...
     */
    public static Employee createEmployee (@NotNull String firstName, @NotNull String lastName, int id) throws Exception
    {
     ...
     */
    public static Manager createManager (@NotNull String firstName, @NotNull String lastName)
    {
     ...
     * @throws Exception if there already is an employee with this ID
     */
    public static Manager createManager (@NotNull String firstName, @NotNull String lastName, int id) throws Exception
    {
     ...
     * @return this
     */
    public Company addStandardDepartment (@NotNull StandardDepartment department)
    {
     ...
     */
    public static StandardDepartment createStandardDepartment (@NotNull String name, @NotNull String activitySector)
    {
     ...
     * @return the new standard department
     */
    public static StandardDepartment createStandardDepartment (@NotNull String name, @NotNull String activitySector, @NotNull Manager
            manager)
    {
     ...
     */
    public ObservableList<Employee> searchEmployee (@NotNull String firstName, @NotNull String lastName)
    {
     ...
     */
    public ObservableList<Employee> searchEmployee (@NotNull String name)
    {
     ...
     *
     * @param name           the name
     * @param activitySector the activity sector
     * @return a list of {@link StandardDepartment} instances matching with the parameters
     */
    public ObservableList<StandardDepartment> searchStandardDepartment (@NotNull String name, @NotNull String activitySector)
    {
     ...
     */
    private void loadEmployees (@NotNull JSONArray json)
    {
        if (json == null)
        {
            System.err.println("Failed to load employees from JSON...");
            return;
        }
     ...
     */
    private void loadStandardDepartments (@NotNull JSONArray json)
    {
        if (json == null)
        {
            System.err.println("Failed to load standard departments from JSON...");
            return;
        }
     ...
     */
    private void loadCompany (@NotNull JSONObject json)
    {
        if (json == null)
        {
            System.err.println("Failed to load Boss from JSON...");
            return;
        }
     ...
     */
    private void loadBoss (@NotNull JSONObject json)
    {
        if (json == null)
        {
            System.err.println("Failed to load Boss from JSON...");
     ...
     */
    private void loadManagementDepartment (@NotNull JSONObject json)
    {
        if (json == null)
        {
            System.err.println("Failed to load Management Department from JSON...");
            return;
        }
    ...
    public void deserialize ()
    {
        ...
        if (f.exists())
        {
            ...
            {
                System.err.println("Loading json from file failed...");
                e.printStackTrace();
            }
        }
        else
        {
            System.err.println("Loading json from file failed: file '" + serializationFilePath + "' not found.");
        }
    }
     ...
     */
    void incrementChecksOutAt (@NotNull SimpleDate date)
    {
        int total = 0;
     ...
     */
    void incrementChecksInAt (@NotNull SimpleDate date)
    {
        int total = 0;
     ...
     * @param date the date of the check out
     */
    void decrementChecksOutAt (@NotNull SimpleDate date)
    {
        int total = 0;
        if (totalChecksOutPerDay.containsKey(date))
        {
     ...
     * @param date the date of the check in
     */
    void decrementChecksInAt (@NotNull SimpleDate date)
    {
        int total = 0;
        if (totalChecksInPerDay.containsKey(date))
        {
     ...
     */
    public void saveEmployeesToCSV (@NotNull File file)
    {
     ...
     * @param file the destination file
     */
    public void saveDepartmentsToCSV (@NotNull File file)
    {
        CSVParser parser           = new CSVParser();
     ...
     */
    public void loadEmployeesFromCSVFile (@NotNull File file) throws FileNotFoundException
    {
     ...
     * @throws FileNotFoundException if the file has not been found
     */
    public void loadDepartmentsFromCSVFile (@NotNull File file) throws FileNotFoundException
    {
        final CSVParser parser = CSVParser.loadFromFile(file);
