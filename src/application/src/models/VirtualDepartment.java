...
public abstract class VirtualDepartment<EmployeesClass> implements Jsonable
{
     ...
     */
    public VirtualDepartment (@NotNull String name, @NotNull String activitySector)
    {
     ...
     * @return this
     */
    public VirtualDepartment setName (@NotNull String name)
    {
        this.name.setValue(name);
        return this;
    }
     ...
     * @return this
     */
    public VirtualDepartment setActivitySector (@NotNull String activitySector)
    {
        this.activitySector.setValue(activitySector);
        return this;
    }
     ...
     */
    void setEmployees (@NotNull ObservableList<EmployeesClass> employees)
    {
