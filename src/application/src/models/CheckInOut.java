...
public class CheckInOut implements Jsonable
{
     ...
     */
    CheckInOut (@NotNull Employee employee, @NotNull SimpleDate date)
    {
     ...
     */
    CheckInOut (@NotNull Employee employee, @NotNull SimpleDateTime dateTime)
    {
        this.employee = employee;
     ...
     */
    public void setArrivedAt (@NotNull SimpleTime arrivedAt)
    {
        checkIn(arrivedAt);
    }
     ...
     */
    public void setLeftAt (@NotNull SimpleTime leftAt)
    {
        checkOut(leftAt);
    }
     ...
     */
    void check (@NotNull SimpleDateTime dateTime)
    {
     ...
     */
    private void checkIn (@NotNull SimpleTime time)
    {
     ...
     */
    private void checkOut (@NotNull SimpleTime time)
    {
     ...
     */
    public static CheckInOut loadFromJson (@NotNull Employee employee, @NotNull JSONObject obj)
    {
