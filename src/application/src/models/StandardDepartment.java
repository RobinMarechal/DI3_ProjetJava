...
public class StandardDepartment extends VirtualDepartment<Employee> implements Jsonable, CSVBuilder
{
     ...
     */
    public StandardDepartment (@NotNull String name, @NotNull String activitySector, Manager manager)
    {
     ...
     */
    public StandardDepartment (@NotNull String name, @NotNull String activitySector, int id)
    {
     ...
     * @param activitySector the department's activitySector
     */
    public StandardDepartment (@NotNull String name, @NotNull String activitySector)
    {
        super(name, activitySector);
     ...
     * @return this
     */
    public StandardDepartment addAllEmployees (@NotNull Employee... employees)
    {
     ...
     * @return this
     */
    public StandardDepartment setManager (@NotNull Manager manager)
    {
     ...
     */
    public static StandardDepartment loadFromJson (@NotNull JSONObject json)
    {
