...
public class Form extends HashMap<String, Form.Field>
{
     ...
     */
    public void add (@NotNull String key, @NotNull FieldValueTypes valueType, @NotNull Control field, @NotNull FieldTypes type)
    {
        super.put(key, new Field(field, type, valueType));
    }

    /**
     * Add a {@link TextField} field to the form
     *
     * @param key       the HashMap key
     * @param valueType the type of the value (e.g. firstname, date, datetime...)
     * @param field     the field
     */
    public void add (@NotNull String key, @NotNull FieldValueTypes valueType, @NotNull Control field)
    {
    ...
    public class Field
    {
         ...
         */
        public void setType (@NotNull FieldTypes type)
        {
            this.type = type;
        }
         ...
         */
        public void setValueTypes (@NotNull FieldValueTypes valueTypes)
        {
